...
1. Uninstall Salesforce Extension Pack from VS code extensions
2. Delete all salesforce related folders under the vs code extensions folder, you can find them in:
   > Windows %USERPROFILE%.vscode\extensions
   > macOS ~/.vscode/extensions
   > Linux ~/.vscode/extensions
3. Install Salesforce Extension Pack back again
